...
export async function saveProductData(brand, title, description, price, productType, size, rating, skinType, ingredients, selectedImageUrl ) {
  const productData = { brand, title, description, price, productType, size, rating, skinType, ingredients };
  ...
  export async function loadProductData(productType) {
    try {
